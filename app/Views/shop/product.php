                    ...
                    <div class="col-lg-6">
                        <div class="product-details">
                            ...
                            <div class="pd-desc">
                                ...
                                <div class="form-group">
                                    <label for="diskon">Pilih Kode Voucher</label>
                                    <select class="form-control" id="diskonf">
                                        <option value="0" selected>Dapatkan Keuntungan extra</option>
                                        <?php foreach ($diskon as $index => $diskon) {
                                                if ($diskon->aktif == 1) {
                                                    if (strtotime($diskon->tanggal_mulai) <= strtotime(date('Y-m-d H:i:s')) && strtotime($diskon->tanggal_akhir) >= strtotime(date('Y-m-d H:i:s'))) {
                                                        echo "<option value=" . $diskon->besar_diskon . ">" . $diskon->kode_voucher . " (Potongan $diskon->besar_diskon %)</option>";
                                                    }
                                                }
                                            }
                                            ?>
...
$('document').ready(function() {
    ...
    $("#service").on('change', function() {
        ...
        var total_harga = ((jumlah_pembelian * harga) - ((jumlah_pembelian * harga) * diskon / 100)) +
            ongkir;
        var total_jumlah_harga = total_harga
        $("#total_harga").val(total_harga);
    ...
    $("#diskonf").on('change', function() {
        ...
        var total_harga = ((jumlah_pembelian * harga) - ((jumlah_pembelian * harga) * diskon / 100)) +
            ongkir;
        var total_jumlah_harga = total_harga
        $("#total_harga").val(total_jumlah_harga);
        $("#total_jumlah_harga").val(total_jumlah_harga);
    });
